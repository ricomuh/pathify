...
*/
        $this->categories = collect([
            ...
            [
                ...
                'color' => '#FF00FF',
                // 'icon' => 'fas fa-cogs',
                'image' => 'pengelola-infrastruktur.png',
                '1st_category' => 'DevOps',
                '2nd_category' => null,
            ],
            [
            ...
            [
                ...
                'image' => 'perancang-pengalaman.png',
            ...
            [
                ...
                'color' => '#000080',
                // 'icon' => 'fas fa-mobile-alt'
                'image' => 'pendesain-aplikasi-seluler.png',
                '1st_category' => 'Mobile Development',
                '2nd_category' => 'UI/UX Design',
            ],
            [
            ...
            [
                ...
                'color' => '#008080',
                // 'icon' => 'fas fa-shield-alt',
                'image' => 'pengawal-infrastruktur.png',
                '1st_category' => 'Cybersecurity',
                '2nd_category' => 'DevOps',
            ],
            [
                ...
                'color' => '#800080',
                // 'icon' => 'fas fa-gamepad',
                'image' => 'desainer-dunia-virtual.png',
                '1st_category' => 'Game Development',
                '2nd_category' => 'UI/UX Design',
            ],
            [
            ...
            [
                ...
                'color' => '#000080',
                // 'icon' => 'fas fa-mobile-alt',
                'image' => 'operator-aplikasi-mobile.png',
                '1st_category' => 'DevOps',
            ...
            [
                ...
                'color' => '#800000',
                // 'icon' => 'fas fa-shield-alt',
                'image' => 'analis-keamanan-data.png',
                '1st_category' => 'Data Science',
            ...
            [
                ...
                'color' => '#FF4500',
                // 'icon' => 'fas fa-gamepad',
                'image' => 'programmer-interaktif.png',
                '1st_category' => 'Frontend Development',
    ...
    public function run(): void
    {
        ...
        $this->categories->each(function ($category) use ($categories) {
            QuestionnaireResultCategory::create([
                ...
                // 'icon' => $category['icon'],
                'image' => asset('media/result/' . $category['image']),
